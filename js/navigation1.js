window.onload=function(){
   ...
   var height=$(window).height();
    ...
    $("#line1").click(function(){
    	var place1=document.getElementById('place1').value;
    	 //将汉字转成unicode编码
        var str=escape(place1).toLocaleLowerCase().replace(/%u/gi,'\\u');
        //用拼接字符串的方式正则表达式
        var string="/"+str+"/g";
        //将字符串转成正则表达式
        ...
        document.getElementById("mid").innerHTML = body;
         $('.location').click(function(){
           ...
           console.log(TargetX);
           console.log(TargetY);           
           window.location.href='navigation1.html?TargetX='+TargetX+'&TargetY='+TargetY+'&telephone='+telephone;         
          })
        }
        else{
            console.log("服务器异常")
 ...
 $("#line").click(function(){
  ...
  $(".content1").show();
  $("body").css({"height":height,"backgroundColor":"#eeeeee"});
  //window.location.href="navigation2.html#"+place;
  //
