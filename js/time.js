...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      //actions
      header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '      <div class="sc-yleft">' + '        &lsaquo;</div>' + '    <div>  <select class="sc-select-year" name="">' + '      </select></div>' + '      <div class="sc-yright">&rsaquo;</div>' + '  </div>';
      header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '    <div class="sc-mleft">' + '      &lsaquo;</div>' + '  <div>  <select class="sc-select-month" name="">' + '    </select></div>' + '    <div class="sc-mright">&rsaquo;</div>' + '</div>';
  ...
  var year = date.getFullYear(); 
    ...
    value: function addData(year, month) {
      ...
      //计算得到第一个格子的日期
      var thispageStart = new Date(Date.parse(day) - (week ) * 24 * 3600 * 1000);//改改改week-1
    ...
    value: function getSelectedDay() {
      ...
      console.log(Date(selectYear, selectMonth - 1, selectDay))
    }
...
SimpleCalendar.prototype.languageData = {
  ...
  months_CH: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一", "十二"],
  vocation: {
