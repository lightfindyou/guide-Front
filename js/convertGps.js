...
/*
    ...
    说明：入口参数和返回值使用的是腾讯坐标，如果你使用的是其他坐标，务必先建立其与腾讯坐标的映射
*/
var adsorption_rectify = function (p, points) {

    /*
     * 吸附修正允許偏差，调整这个参数改变你需要的精确度
     */
    var ad_deviation = 0.00005;
...
var projection_rectify = function (p, points) {
     ...
     * 调整这两个参数改变你需要的精确度
     */
    var equel_deviation = 0.00003;
    var pro_deviation = 0.00013;
...
*/
var convertGpsToTencent = function (p_Lng, p_Lat) {
